...
```bash
aws s3api create-bucket --bucket file-service-tfstate-dev-us-east-1 --region us-east-1
aws dynamodb create-table \
    --table-name file-service-tflocks-dev \
...
docker build -t file-service-api:dev .

# 3. Tag Docker Image
docker tag file-service-api:dev <ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/file-service-api-dev:latest
