# 🏛️ AWS Cloud Architecture — Multi-Tenant File Service API

This document presents the complete architectural design of the AWS infrastructure hosting the **Multi-Tenant File Service API**, built and managed with Terraform.
...
| **Custom Domain** | `fileservice.example.com` | ❌ | When provisioned |
| **Deletion Protection** | ❌ | ❌ | ✅ |
...
The auto-provisioned dashboard (`file-service-{env}-dashboard`) displays:
