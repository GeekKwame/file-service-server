...
aws rds restore-db-instance-to-point-in-time \
    --source-db-instance-identifier file-service-production-db \
    --target-db-instance-identifier file-service-production-db-restored \
...
aws secretsmanager update-secret \
    --secret-id file-service/production/app-secrets \
...
aws rds restore-db-instance-from-db-snapshot \
    --db-instance-identifier file-service-production-db-from-snapshot \
...
aws s3api list-object-versions \
    --bucket file-service-storage-production-<ACCOUNT_ID> \
...
aws s3api copy-object \
    --bucket file-service-storage-production-<ACCOUNT_ID> \
    --copy-source file-service-storage-production-<ACCOUNT_ID>/app_id/file_uuid-filename?versionId=<VERSION_ID> \
