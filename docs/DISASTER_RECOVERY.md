# 🛡️ Disaster Recovery Plan — File Service Infrastructure
...
aws rds restore-db-instance-from-db-snapshot \
    --db-instance-identifier file-service-dev-db-restored \
    --db-snapshot-identifier <SNAPSHOT_ID> \
    --db-instance-class db.t4g.micro \
    --db-subnet-group-name file-service-dev-db-subnet-group \
...
aws rds describe-events \
    --source-identifier file-service-production-db \
...
aws rds restore-db-instance-to-point-in-time \
    ...
    --target-db-instance-identifier file-service-dev-db-pitr \
